 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostContactPersonsContactPerson implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'postContactPersons_contact_person';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['contact_person_type_ids'] === null) {
            $invalidProperties[] = "'contact_person_type_ids' can't be null";
        }
