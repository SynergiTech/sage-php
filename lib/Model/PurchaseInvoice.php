...
class PurchaseInvoice implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'corrections' => '\Swagger\Client\Model\PurchaseCorrectiveInvoice[]',
        'tax_reconciled' => 'bool',
        'migrated' => 'bool',
     ...
     * Sets transaction
     *
     * @param \Swagger\Client\Model\Transaction $transaction The transaction record for the purchase invoice
     *
     * @return $this
     */
     ...
     * Sets contact
     *
     * @param \Swagger\Client\Model\Contact $contact The contact the purchase invoice relates to
     *
     * @return $this
     */
    ...
    public function setContactName($contact_name)
    {
        if (!is_null($contact_name) && (mb_strlen($contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $contact_name when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setContactReference($contact_reference)
    {
        if (!is_null($contact_reference) && (mb_strlen($contact_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $contact_reference when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setReference($reference)
    {
        if (!is_null($reference) && (mb_strlen($reference) > 25)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling PurchaseInvoice., must be smaller than or equal to 25.');
        }
    ...
    public function setVendorReference($vendor_reference)
    {
        if (!is_null($vendor_reference) && (mb_strlen($vendor_reference) > 31)) {
            throw new \InvalidArgumentException('invalid length for $vendor_reference when calling PurchaseInvoice., must be smaller than or equal to 31.');
        }
    ...
    public function setNotes($notes)
    {
        if (!is_null($notes) && (mb_strlen($notes) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling PurchaseInvoice., must be smaller than or equal to 2000.');
        }
    ...
    public function setVoidReason($void_reason)
    {
        if (!is_null($void_reason) && (mb_strlen($void_reason) > 255)) {
            throw new \InvalidArgumentException('invalid length for $void_reason when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
     ...
     * Sets corrections
     *
     * @param \Swagger\Client\Model\PurchaseCorrectiveInvoice[] $corrections The corrective entries associated with the invoice
     *
     * @return $this
     */
     ...
     * Sets tax_reconciled
     *
     * @param bool $tax_reconciled Indicates if the purchase invoice is tax reconciled or not.
     *
     * @return $this
     */
     ...
     * Sets migrated
     *
     * @param bool $migrated Indicates if the purchase invoice was migrated from another system.
     *
     * @return $this
     */
     ...
     *
     * @param string $tax_calculation_method The tax calculation method, if applicable, for this purchase invoice, returns invoice or cash.
     *
     * @return $this
     */
