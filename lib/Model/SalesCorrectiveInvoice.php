...
/**
 * SalesCorrectiveInvoice Class Doc Comment
 *
 * @category Class
 * @description ### Endpoint Availability  * Accounting Plus: 🇪🇸 * Accounting Standard: 🇪🇸 * Accounting Start: 🇪🇸  ### Access Control Restrictions  Requires the authenticated user to have any of the following roles in the area &#x60;Sales&#x60;: Full Access
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SalesCorrectiveInvoice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SalesCorrectiveInvoice';
    ...
    protected static $swaggerTypes = [
        ...
        'corrective_reason_code' => '\Swagger\Client\Model\Base',
    ...
    protected static $setters = [
        ...
        'corrective_reason_code' => 'setCorrectiveReasonCode',
    ...
    protected static $getters = [
        ...
        'corrective_reason_code' => 'getCorrectiveReasonCode',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['corrective_reason_code'] = isset($data['corrective_reason_code']) ? $data['corrective_reason_code'] : null;
     ...
     * Sets transaction
     *
     * @param \Swagger\Client\Model\Transaction $transaction The transaction record for the sales corrective invoice
     *
     * @return $this
     */
     ...
     * Sets contact
     *
     * @param \Swagger\Client\Model\Contact $contact The contact the sales corrective invoice relates to
     *
     * @return $this
     */
    ...
    public function setInvoiceNumberPrefix($invoice_number_prefix)
    {
        if (!is_null($invoice_number_prefix) && (mb_strlen($invoice_number_prefix) > 6)) {
            throw new \InvalidArgumentException('invalid length for $invoice_number_prefix when calling SalesCorrectiveInvoice., must be smaller than or equal to 6.');
        }
    ...
    public function setContactName($contact_name)
    {
        if (!is_null($contact_name) && (mb_strlen($contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $contact_name when calling SalesCorrectiveInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setContactReference($contact_reference)
    {
        if (!is_null($contact_reference) && (mb_strlen($contact_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $contact_reference when calling SalesCorrectiveInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setReference($reference)
    {
        if (!is_null($reference) && (mb_strlen($reference) > 25)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling SalesCorrectiveInvoice., must be smaller than or equal to 25.');
        }
    ...
    public function setMainAddressFreeForm($main_address_free_form)
    {
        if (!is_null($main_address_free_form) && (mb_strlen($main_address_free_form) > 500)) {
            throw new \InvalidArgumentException('invalid length for $main_address_free_form when calling SalesCorrectiveInvoice., must be smaller than or equal to 500.');
        }
    ...
    public function setDeliveryAddressFreeForm($delivery_address_free_form)
    {
        if (!is_null($delivery_address_free_form) && (mb_strlen($delivery_address_free_form) > 500)) {
            throw new \InvalidArgumentException('invalid length for $delivery_address_free_form when calling SalesCorrectiveInvoice., must be smaller than or equal to 500.');
        }
    ...
    public function setNotes($notes)
    {
        if (!is_null($notes) && (mb_strlen($notes) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling SalesCorrectiveInvoice., must be smaller than or equal to 2000.');
        }
    ...
    public function setTermsAndConditions($terms_and_conditions)
    {
        if (!is_null($terms_and_conditions) && (mb_strlen($terms_and_conditions) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $terms_and_conditions when calling SalesCorrectiveInvoice., must be smaller than or equal to 2000.');
        }
    ...
    public function setVoidReason($void_reason)
    {
        if (!is_null($void_reason) && (mb_strlen($void_reason) > 200)) {
            throw new \InvalidArgumentException('invalid length for $void_reason when calling SalesCorrectiveInvoice., must be smaller than or equal to 200.');
        }
    ...
    /**
     * Gets corrective_reason_code
     *
     * @return \Swagger\Client\Model\Base
     */
    public function getCorrectiveReasonCode()
    {
        return $this->container['corrective_reason_code'];
    }

    /**
     * Sets corrective_reason_code
     *
     * @param \Swagger\Client\Model\Base $corrective_reason_code The reason for the corrective invoice
     *
     * @return $this
     */
    public function setCorrectiveReasonCode($corrective_reason_code)
    {
        $this->container['corrective_reason_code'] = $corrective_reason_code;
