 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessType';
     ...
     * Sets name
     *
     * @param string $name The name of the business type
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description The description of the business type
     *
     * @return $this
     */
