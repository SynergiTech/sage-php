 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressRegion implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddressRegion';
     ...
     * Sets code
     *
     * @param string $code The code of the address region
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of the address region
     *
     * @return $this
     */
