 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostContactsContact implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'postContacts_contact';
    ...
    public function setCreditDays($credit_days)
    {
        ...
        if (!is_null($credit_days) && ($credit_days > 365)) {
            throw new \InvalidArgumentException('invalid value for $credit_days when calling PostContactsContact., must be smaller than or equal to 365.');
        }
        if (!is_null($credit_days) && ($credit_days < 0)) {
            throw new \InvalidArgumentException('invalid value for $credit_days when calling PostContactsContact., must be bigger than or equal to 0.');
        }
