...
class SalesQuote implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'sent' => 'bool',
        'sent_by_email' => 'bool',
        'quote_lines' => '\Swagger\Client\Model\SalesQuoteLineItem[]',
     ...
     * Sets contact
     *
     * @param \Swagger\Client\Model\Contact $contact The contact the quote relates to
     *
     * @return $this
     */
     ...
     *
     * @param string $quote_number_prefix The quote number prefix
     *
     * @return $this
     */
    public function setQuoteNumberPrefix($quote_number_prefix)
    {
        if (!is_null($quote_number_prefix) && (mb_strlen($quote_number_prefix) > 6)) {
            throw new \InvalidArgumentException('invalid length for $quote_number_prefix when calling SalesQuote., must be smaller than or equal to 6.');
        }
     ...
     * Sets quote_number
     *
     * @param string $quote_number The generated quote number
     *
     * @return $this
     */
     ...
     * Sets contact_name
     *
     * @param string $contact_name The name of the contact when the quote was created
     *
     * @return $this
     */
    public function setContactName($contact_name)
    {
        if (!is_null($contact_name) && (mb_strlen($contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $contact_name when calling SalesQuote., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param string $contact_reference The reference of the contact when the quote was created
     *
     * @return $this
     */
    public function setContactReference($contact_reference)
    {
        if (!is_null($contact_reference) && (mb_strlen($contact_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $contact_reference when calling SalesQuote., must be smaller than or equal to 255.');
        }
     ...
     * Sets reference
     *
     * @param string $reference The reference for the quote
     *
     * @return $this
     */
    public function setReference($reference)
    {
        if (!is_null($reference) && (mb_strlen($reference) > 25)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling SalesQuote., must be smaller than or equal to 25.');
        }
     ...
     *
     * @param string $main_address_free_form The free-form main address of the quote Note: An upper length limit of 500 characters is imposed conditionally and may not apply in every request. A hard upper limit of 65535 characters is imposed by the storage layer, though.
     *
     * @return $this
     */
    public function setMainAddressFreeForm($main_address_free_form)
    {
        if (!is_null($main_address_free_form) && (mb_strlen($main_address_free_form) > 500)) {
            throw new \InvalidArgumentException('invalid length for $main_address_free_form when calling SalesQuote., must be smaller than or equal to 500.');
        }
     ...
     * Sets main_address
     *
     * @param \Swagger\Client\Model\SalesArtefactAddress $main_address The main address of the quote
     *
     * @return $this
     */
     ...
     *
     * @param string $delivery_address_free_form The free-form delivery address of the quote Note: An upper length limit of 500 characters is imposed conditionally and may not apply in every request. A hard upper limit of 65535 characters is imposed by the storage layer, though.
     *
     * @return $this
     */
    public function setDeliveryAddressFreeForm($delivery_address_free_form)
    {
        if (!is_null($delivery_address_free_form) && (mb_strlen($delivery_address_free_form) > 500)) {
            throw new \InvalidArgumentException('invalid length for $delivery_address_free_form when calling SalesQuote., must be smaller than or equal to 500.');
        }
     ...
     *
     * @param \Swagger\Client\Model\SalesArtefactAddress $delivery_address The delivery address of the quote
     *
     * @return $this
     */
    ...
    public function setNotes($notes)
    {
        if (!is_null($notes) && (mb_strlen($notes) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling SalesQuote., must be smaller than or equal to 2000.');
        }
     ...
     *
     * @param string $terms_and_conditions Quote terms and conditions
     *
     * @return $this
     */
    public function setTermsAndConditions($terms_and_conditions)
    {
        if (!is_null($terms_and_conditions) && (mb_strlen($terms_and_conditions) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $terms_and_conditions when calling SalesQuote., must be smaller than or equal to 2000.');
        }
     ...
     *
     * @param \Swagger\Client\Model\TaxBreakdown[] $shipping_tax_breakdown The shipping tax breakdown for the quote
     *
     * @return $this
     */
     ...
     * Sets net_amount
     *
     * @param double $net_amount The net amount of the quote
     *
     * @return $this
     */
     ...
     * Sets tax_amount
     *
     * @param double $tax_amount The tax amount of the quote
     *
     * @return $this
     */
     ...
     * Sets total_amount
     *
     * @param double $total_amount The total amount of the quote
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param \Swagger\Client\Model\Base $currency The currency for the quote
     *
     * @return $this
     */
     ...
     * Sets exchange_rate
     *
     * @param double $exchange_rate The exchange rate for the quote
     *
     * @return $this
     */
     ...
     *
     * @param double $inverse_exchange_rate The inverse exchange rate for the quote
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\TaxBreakdown[] $base_currency_shipping_tax_breakdown The shipping tax breakdown for the  quote in base currency
     *
     * @return $this
     */
     ...
     * Sets total_quantity
     *
     * @param double $total_quantity The total quantity of the quote
     *
     * @return $this
     */
     ...
     *
     * @param double $total_discount_amount The discount amount on the  quote
     *
     * @return $this
     */
     ...
     *
     * @param double $base_currency_total_discount_amount The discount amount on the  quote in base currency
     *
     * @return $this
     */
     ...
     *
     * @param double $base_currency_net_amount The net amount of the quote in base currency
     *
     * @return $this
     */
     ...
     *
     * @param double $base_currency_tax_amount The tax amount of the quote in base currency
     *
     * @return $this
     */
     ...
     *
     * @param double $base_currency_total_amount The total amount of the quote in base currency
     *
     * @return $this
     */
     ...
     * Sets total_paid
     *
     * @param double $total_paid The total paid amount of the quote including any payments, allocations and discounts
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param \Swagger\Client\Model\QuoteStatus $status The status of the quote
     *
     * @return $this
     */
     ...
     * Sets sent
     *
     * @param bool $sent Indicates whether the quote has been sent
     *
     * @return $this
     */
     ...
     * Sets sent_by_email
     *
     * @param bool $sent_by_email Indicates whether the quote has been emailed
     *
     * @return $this
     */
     ...
     * Sets quote_lines
     *
     * @param \Swagger\Client\Model\SalesQuoteLineItem[] $quote_lines The quote lines of the quote
     *
     * @return $this
     */
     ...
     * Sets tax_analysis
     *
     * @param \Swagger\Client\Model\ArtefactTaxAnalysis[] $tax_analysis The quote tax analysis
     *
     * @return $this
     */
     ...
     * Sets invoice
     *
     * @param \Swagger\Client\Model\Generic $invoice The invoice associated with the quote.
     *
     * @return $this
     */
