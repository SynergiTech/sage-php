...
/**
 * PostPurchaseQuickEntriesPurchaseQuickEntry Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostPurchaseQuickEntriesPurchaseQuickEntry implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'postPurchaseQuickEntries_purchase_quick_entry';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['quick_entry_type_id'] === null) {
            $invalidProperties[] = "'quick_entry_type_id' can't be null";
        }
