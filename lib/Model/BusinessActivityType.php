...
/**
 * BusinessActivityType Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessActivityType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessActivityType';
    ...
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $id when calling BusinessActivityType., must be smaller than or equal to 15.');
        }
