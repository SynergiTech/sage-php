 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MigrationStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MigrationStatus';
     ...
     * Sets id
     *
     * @param string $id The migration status id
     *
     * @return $this
     */
     ...
     * Sets displayed_as
     *
     * @param string $displayed_as The migration status name
     *
     * @return $this
     */
