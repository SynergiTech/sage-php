 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostStockItemsStockItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'postStockItems_stock_item';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sales_ledger_account_id'] === null) {
            $invalidProperties[] = "'sales_ledger_account_id' can't be null";
        }
        if ($this->container['purchase_ledger_account_id'] === null) {
            $invalidProperties[] = "'purchase_ledger_account_id' can't be null";
        }
