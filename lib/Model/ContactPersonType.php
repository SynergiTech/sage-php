 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContactPersonType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactPersonType';
    ...
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ContactPersonType., must be smaller than or equal to 15.');
        }
