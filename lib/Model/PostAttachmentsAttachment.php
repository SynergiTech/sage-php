 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostAttachmentsAttachment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'postAttachments_attachment';
    ...
    public function setFileSize($file_size)
    {
        ...
        if (!is_null($file_size) && ($file_size > 2621440)) {
            throw new \InvalidArgumentException('invalid value for $file_size when calling PostAttachmentsAttachment., must be smaller than or equal to 2621440.');
        }
        if (!is_null($file_size) && ($file_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $file_size when calling PostAttachmentsAttachment., must be bigger than or equal to 0.');
        }
