...
class Service implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'sales_rates' => '\Swagger\Client\Model\Rate[]',
        'source_guid' => 'string',
     ...
     * Sets deletable
     *
     * @param bool $deletable Indicates whether the service can be deleted
     *
     * @return $this
     */
     ...
     * Sets deactivatable
     *
     * @param bool $deactivatable Indicates whether the service can be deactivated
     *
     * @return $this
     */
     ...
     *
     * @param bool $used_on_recurring_invoice Indicates whether the service has been used on a recurring invoice
     *
     * @return $this
     */
    ...
    public function setItemCode($item_code)
    {
        if (!is_null($item_code) && (mb_strlen($item_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $item_code when calling Service., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param \Swagger\Client\Model\Base $sales_ledger_account The sales ledger account for the service
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Base $purchase_ledger_account The purchase ledger account for the service
     *
     * @return $this
     */
     ...
     * Sets sales_tax_rate
     *
     * @param \Swagger\Client\Model\Base $sales_tax_rate The sales tax rate for the service
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Base $purchase_tax_rate The purchase tax rate for the service
     *
     * @return $this
     */
     ...
     * Sets sales_rates
     *
     * @param \Swagger\Client\Model\Rate[] $sales_rates The sales rates for the service
     *
     * @return $this
     */
    ...
    public function setSourceGuid($source_guid)
    {
        if (!is_null($source_guid) && (mb_strlen($source_guid) > 255)) {
            throw new \InvalidArgumentException('invalid length for $source_guid when calling Service., must be smaller than or equal to 255.');
        }
    ...
    public function setPurchaseDescription($purchase_description)
    {
        if (!is_null($purchase_description) && (mb_strlen($purchase_description) > 250)) {
            throw new \InvalidArgumentException('invalid length for $purchase_description when calling Service., must be smaller than or equal to 250.');
        }
     ...
     * Sets usual_supplier
     *
     * @param \Swagger\Client\Model\Contact $usual_supplier The usual supplier for the service
     *
     * @return $this
     */
