...
class Journal implements ModelInterface, ArrayAccess
{
     ...
     * Sets journal_code
     *
     * @param \Swagger\Client\Model\JournalCode $journal_code The journal code of the journal (France only)
     *
     * @return $this
     */
     ...
     * Sets journal_lines
     *
     * @param \Swagger\Client\Model\JournalLine[] $journal_lines The journal lines
     *
     * @return $this
     */
     ...
     * Sets migrated
     *
     * @param bool $migrated Indicates if the journal was migrated from another system.
     *
     * @return $this
     */
