 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PutBankAccountsBankAccount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'putBankAccounts_bank_account';
    ...
    public function setNominalCode($nominal_code)
    {
        ...
        if (!is_null($nominal_code) && ($nominal_code > 99999999)) {
            throw new \InvalidArgumentException('invalid value for $nominal_code when calling PutBankAccountsBankAccount., must be smaller than or equal to 99999999.');
        }
        if (!is_null($nominal_code) && ($nominal_code < 1)) {
            throw new \InvalidArgumentException('invalid value for $nominal_code when calling PutBankAccountsBankAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setGifiCode($gifi_code)
    {
        ...
        if (!is_null($gifi_code) && ($gifi_code > 9999)) {
            throw new \InvalidArgumentException('invalid value for $gifi_code when calling PutBankAccountsBankAccount., must be smaller than or equal to 9999.');
        }
        if (!is_null($gifi_code) && ($gifi_code < 1000)) {
            throw new \InvalidArgumentException('invalid value for $gifi_code when calling PutBankAccountsBankAccount., must be bigger than or equal to 1000.');
        }
