 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LegalFormType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LegalFormType';
    ...
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $id when calling LegalFormType., must be smaller than or equal to 15.');
        }
