...
**quoteLines** | [**\SynergiTech\Sage\Model\PostSalesEstimatesSalesEstimateEstimateLinesInner[]**](PostSalesEstimatesSalesEstimateEstimateLinesInner.md) | The quote lines of the quote |
