...
# **getInvoiceSettings**
> \Swagger\Client\Model\InvoiceSettings getInvoiceSettings($show_legacy_id)
...
$apiInstance = new Swagger\Client\Api\InvoiceSettingsApi(
...
[**\Swagger\Client\Model\InvoiceSettings**](../Model/InvoiceSettings.md)
...
# **putInvoiceSettings**
> \Swagger\Client\Model\InvoiceSettings putInvoiceSettings($put_invoice_settings)
...
$put_invoice_settings = new \Swagger\Client\Model\PutInvoiceSettings(); // \Swagger\Client\Model\PutInvoiceSettings | 

try {
    $result = $apiInstance->putInvoiceSettings($put_invoice_settings);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **put_invoice_settings** | [**\Swagger\Client\Model\PutInvoiceSettings**](../Model/PutInvoiceSettings.md)|  | [optional]
