...
# **getMigrations**
> \Swagger\Client\Model\Migration getMigrations($show_legacy_id)
...
$apiInstance = new Swagger\Client\Api\MigrationsApi(
...
[**\Swagger\Client\Model\Migration**](../Model/Migration.md)
...
# **putMigrations**
> \Swagger\Client\Model\Migration putMigrations($put_migrations)
...
$put_migrations = new \Swagger\Client\Model\PutMigrations(); // \Swagger\Client\Model\PutMigrations | 

try {
    $result = $apiInstance->putMigrations($put_migrations);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **put_migrations** | [**\Swagger\Client\Model\PutMigrations**](../Model/PutMigrations.md)|  | [optional]
