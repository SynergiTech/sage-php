...
# **getCountries**
> \Swagger\Client\Model\BaseArray getCountries($show_legacy_id, $items_per_page, $page, $attributes)
...
$show_legacy_id = true; // bool | Display the legacy_id for the Countries.
$items_per_page = 20; // int | Format - int32. Returns the given number of Countries per request.
...
try {
    $result = $apiInstance->getCountries($show_legacy_id, $items_per_page, $page, $attributes);
    print_r($result);
} catch (Exception $e) {
 ...
 **items_per_page** | **int**| Format - int32. Returns the given number of Countries per request. | [optional] [default to 20]
...
# **getCountriesKey**
> \Swagger\Client\Model\Base getCountriesKey($key, $show_legacy_id, $attributes)
...
$show_legacy_id = true; // bool | Display the legacy_id for the Country.
...
try {
    $result = $apiInstance->getCountriesKey($key, $show_legacy_id, $attributes);
    print_r($result);
} catch (Exception $e) {
