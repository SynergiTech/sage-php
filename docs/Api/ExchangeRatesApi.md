# Swagger\Client\ExchangeRatesApi
...
# **getExchangeRates**
> \Swagger\Client\Model\ExchangeRateArray getExchangeRates($show_legacy_id, $items_per_page, $page, $attributes)
...
$apiInstance = new Swagger\Client\Api\ExchangeRatesApi(
...
try {
    $result = $apiInstance->getExchangeRates($show_legacy_id, $items_per_page, $page, $attributes);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ExchangeRateArray**](../Model/ExchangeRateArray.md)
...
# **getExchangeRatesKey**
> \Swagger\Client\Model\ExchangeRate getExchangeRatesKey($key, $show_legacy_id, $attributes)
...
try {
    $result = $apiInstance->getExchangeRatesKey($key, $show_legacy_id, $attributes);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ExchangeRate**](../Model/ExchangeRate.md)
