...
class UnallocatedArtefactsApi
{
     ...
     * @param  int|null $itemsPerPage Format - int32. Returns the given number of Base Artefacts per request. (optional, default to 20)
     * @param  int|null $page Format - int32. Go to specific page of Base Artefacts (optional, default to 1)
     * @param  bool|null $showLegacyId Display the legacy_id for the Base Artefacts. (optional)
    ...
    {
        list($response) = $this->getUnallocatedArtefactsWithHttpInfo($contactId, $search, $attributes, $itemsPerPage, $page, $showLegacyId, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getUnallocatedArtefactsRequest($contactId, $search, $attributes, $itemsPerPage, $page, $showLegacyId, $contentType);
    ...
    {
        return $this->getUnallocatedArtefactsAsyncWithHttpInfo($contactId, $search, $attributes, $itemsPerPage, $page, $showLegacyId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  bool|null $showLegacyId Display the legacy_id for the Base Artefact. (optional)
    ...
    {
        list($response) = $this->getUnallocatedArtefactsKeyWithHttpInfo($key, $showLegacyId, $attributes, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getUnallocatedArtefactsKeyRequest($key, $showLegacyId, $attributes, $contentType);
    ...
    {
        return $this->getUnallocatedArtefactsKeyAsyncWithHttpInfo($key, $showLegacyId, $attributes, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
