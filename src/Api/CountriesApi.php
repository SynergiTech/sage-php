...
class CountriesApi
{
     ...
     *
     * @param  int|null $itemsPerPage Returns the given number of Countries per request. (optional, default to 20)
     * @param  int|null $page Go to specific page of Countries (optional, default to 1)
    ...
    {
        list($response) = $this->getCountriesWithHttpInfo($itemsPerPage, $page, $attributes, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getCountriesRequest($itemsPerPage, $page, $attributes, $contentType);
    ...
    {
        return $this->getCountriesAsyncWithHttpInfo($itemsPerPage, $page, $attributes, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->getCountriesKeyWithHttpInfo($key, $attributes, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getCountriesKeyRequest($key, $attributes, $contentType);
    ...
    {
        return $this->getCountriesKeyAsyncWithHttpInfo($key, $attributes, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
