...
class EUGoodsServicesTypesApi
{
     ...
     *
     * @param  int|null $itemsPerPage Returns the given number of EU Goods Services Types per request. (optional, default to 20)
     * @param  int|null $page Go to specific page of EU Goods Services Types (optional, default to 1)
    ...
    {
        list($response) = $this->getEuGoodsServicesTypesWithHttpInfo($itemsPerPage, $page, $attributes, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getEuGoodsServicesTypesRequest($itemsPerPage, $page, $attributes, $contentType);
    ...
    {
        return $this->getEuGoodsServicesTypesAsyncWithHttpInfo($itemsPerPage, $page, $attributes, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->getEuGoodsServicesTypesKeyWithHttpInfo($key, $attributes, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getEuGoodsServicesTypesKeyRequest($key, $attributes, $contentType);
    ...
    {
        return $this->getEuGoodsServicesTypesKeyAsyncWithHttpInfo($key, $attributes, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
