...
class CountryOfRegistrationsApi
{
     ...
     *
     * @param  int|null $itemsPerPage Returns the given number of Registered Countries per request. (optional, default to 20)
     * @param  int|null $page Go to specific page of Registered Countries (optional, default to 1)
    ...
    {
        list($response) = $this->getCountriesOfRegistrationWithHttpInfo($itemsPerPage, $page, $attributes, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getCountriesOfRegistrationRequest($itemsPerPage, $page, $attributes, $contentType);
    ...
    {
        return $this->getCountriesOfRegistrationAsyncWithHttpInfo($itemsPerPage, $page, $attributes, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->getCountriesOfRegistrationKeyWithHttpInfo($key, $attributes, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getCountriesOfRegistrationKeyRequest($key, $attributes, $contentType);
    ...
    {
        return $this->getCountriesOfRegistrationKeyAsyncWithHttpInfo($key, $attributes, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
