...
class ContactOpeningBalanceTypesApi
{
    ...
    {
        list($response) = $this->getContactOpeningBalanceTypesWithHttpInfo($showLegacyId, $itemsPerPage, $page, $attributes, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getContactOpeningBalanceTypesRequest($showLegacyId, $itemsPerPage, $page, $attributes, $contentType);
    ...
    {
        return $this->getContactOpeningBalanceTypesAsyncWithHttpInfo($showLegacyId, $itemsPerPage, $page, $attributes, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->getContactOpeningBalanceTypesKeyWithHttpInfo($key, $showLegacyId, $attributes, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getContactOpeningBalanceTypesKeyRequest($key, $showLegacyId, $attributes, $contentType);
    ...
    {
        return $this->getContactOpeningBalanceTypesKeyAsyncWithHttpInfo($key, $showLegacyId, $attributes, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
