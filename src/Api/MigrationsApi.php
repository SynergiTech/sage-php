...
class MigrationsApi
{
     ...
     *
     * @param  \SynergiTech\Sage\Model\PutMigrations $migrations migrations (required)
    ...
    public function putMigrations(
        \SynergiTech\Sage\Model\PutMigrations $migrations,
        string $contentType = self::contentTypes['putMigrations'][0]
    ): \SynergiTech\Sage\Model\Migration
    {
        list($response) = $this->putMigrationsWithHttpInfo($migrations, $contentType);
        return $response;
    }
     ...
     * Updates a Migrations
     *
     * @param  \SynergiTech\Sage\Model\PutMigrations $migrations (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['putMigrations'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
    ...
    {
        $request = $this->putMigrationsRequest($migrations, $contentType);
    ...
    {
        return $this->putMigrationsAsyncWithHttpInfo($migrations, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($migrations === null || (is_array($migrations) && count($migrations) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $migrations when calling putMigrations'
            );
        }
        ...
        if (isset($migrations)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($migrations));
            } else {
                $httpBody = $migrations;
            }
