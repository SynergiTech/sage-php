 ...
 */
class PostPurchaseQuickEntriesPurchaseQuickEntry implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postPurchaseQuickEntries_purchase_quick_entry';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['quickEntryTypeId'] === null) {
            $invalidProperties[] = "'quickEntryTypeId' can't be null";
        }
     ...
     *
     * @param string $quickEntryTypeId The type of quick entry e.g. invoice or credit note
     *
     * @return $this
     */
     ...
     * Sets contactId
     *
     * @param string $contactId The contact the quick entry relates to
     *
     * @return $this
     */
     ...
     *
     * @param string $ledgerAccountId The associated ledger account
     *
     * @return $this
     */
