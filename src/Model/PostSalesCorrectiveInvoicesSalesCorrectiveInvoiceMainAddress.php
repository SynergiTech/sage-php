 ...
 */
class PostSalesCorrectiveInvoicesSalesCorrectiveInvoiceMainAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postSalesCorrectiveInvoices_sales_corrective_invoice_main_address';
    ...
    */
     ...
     * Sets addressTypeId
     *
     * @param string|null $addressTypeId The ID of the Address Type.
     *
     * @return $this
     */
