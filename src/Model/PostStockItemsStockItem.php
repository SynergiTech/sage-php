...
/**
 * PostStockItemsStockItem Class Doc Comment
 *
 * @package  SynergiTech\Sage
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostStockItemsStockItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postStockItems_stock_item';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['itemCode'] === null) {
            $invalidProperties[] = "'itemCode' can't be null";
        }
     ...
     *
     * @param string $salesLedgerAccountId The sales ledger account for the stock item
     *
     * @return $this
     */
     ...
     *
     * @param string $purchaseLedgerAccountId The purchase ledger account for the stock item
     *
     * @return $this
     */
