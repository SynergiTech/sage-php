...
class PurchaseInvoice implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PurchaseInvoice';
    ...
    protected static array $openAPITypes = [
        ...
        'corrections' => '\SynergiTech\Sage\Model\PurchaseCorrectiveInvoice[]',
        'taxReconciled' => 'bool',
        'migrated' => 'bool',
    ...
    */
     ...
     *
     * @param float|null $baseCurrencyTotalItcAmount The total amount of input tax credit in base currency for the                      purchase invoice (Canada only)
     *
     * @return $this
     */
     ...
     * Sets totalItcAmount
     *
     * @param float|null $totalItcAmount The total amount of input tax credit for the purchase invoice (Canada only)
     *
     * @return $this
     */
     ...
     *
     * @param float|null $baseCurrencyTotalItrAmount The total amount of input tax refund in base currency for the                      purchase invoice (Canada only)
     *
     * @return $this
     */
     ...
     * Sets totalItrAmount
     *
     * @param float|null $totalItrAmount The total amount of input tax refund for the purchase invoice (Canada only)
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $partRecoverable Indicates if the purchase invoice is part recoverable or not (Canada only)
     *
     * @return $this
     */
    ...
    public function setContactName(?string $contactName): static
    {
        ...
        if ((mb_strlen($contactName) > 255)) {
            throw new InvalidArgumentException('invalid length for $contactName when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setContactReference(?string $contactReference): static
    {
        ...
        if ((mb_strlen($contactReference) > 255)) {
            throw new InvalidArgumentException('invalid length for $contactReference when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setVendorReference(?string $vendorReference): static
    {
        ...
        if ((mb_strlen($vendorReference) > 31)) {
            throw new InvalidArgumentException('invalid length for $vendorReference when calling PurchaseInvoice., must be smaller than or equal to 31.');
        }
    ...
    public function setVoidReason(?string $voidReason): static
    {
        ...
        if ((mb_strlen($voidReason) > 255)) {
            throw new InvalidArgumentException('invalid length for $voidReason when calling PurchaseInvoice., must be smaller than or equal to 255.');
        }
     ...
     * Gets corrections
     *
     * @return \SynergiTech\Sage\Model\PurchaseCorrectiveInvoice[]|null
     */
     ...
     * Sets corrections
     *
     * @param \SynergiTech\Sage\Model\PurchaseCorrectiveInvoice[]|null $corrections The corrective entries associated with the invoice
     *
     * @return $this
     */
     ...
     * Sets taxReconciled
     *
     * @param bool|null $taxReconciled Indicates if the purchase invoice is tax reconciled or not.
     *
     * @return $this
     */
     ...
     * Sets migrated
     *
     * @param bool|null $migrated Indicates if the purchase invoice was migrated from another system.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $taxCalculationMethod The tax calculation method, if applicable, for this purchase invoice, returns invoice or cash.
     *
     * @return $this
     */
