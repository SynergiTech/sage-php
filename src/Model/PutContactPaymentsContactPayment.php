...
class PutContactPaymentsContactPayment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'putContactPayments_contact_payment';
    ...
    */
     ...
     * Sets contactId
     *
     * @param string|null $contactId The contact of the payment
     *
     * @return $this
     */
     ...
     * Sets bankAccountId
     *
     * @param string|null $bankAccountId The bank account of the payment
     *
     * @return $this
     */
