 ...
 */
class PutLedgerAccountOpeningBalancesLedgerAccountOpeningBalance implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'putLedgerAccountOpeningBalances_ledger_account_opening_balance';
    ...
    */
     ...
     *
     * @param string|null $ledgerAccountId The ledger account the opening balance relates to
     *
     * @return $this
     */
