 ...
 */
class PostLedgerAccountOpeningBalancesLedgerAccountOpeningBalance implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postLedgerAccountOpeningBalances_ledger_account_opening_balance';
    ...
    */
     ...
     *
     * @param string $ledgerAccountId The ledger account the opening balance relates to
     *
     * @return $this
     */
