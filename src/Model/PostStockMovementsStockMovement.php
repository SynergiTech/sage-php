...
/**
 * PostStockMovementsStockMovement Class Doc Comment
 *
 * @package  SynergiTech\Sage
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostStockMovementsStockMovement implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postStockMovements_stock_movement';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['stockItemId'] === null) {
            $invalidProperties[] = "'stockItemId' can't be null";
        }
     ...
     * Sets stockItemId
     *
     * @param string $stockItemId The stock item of the stock movement
     *
     * @return $this
     */
     ...
     * Sets quantity
     *
     * @param float $quantity The quantity of the goods adjusted
     *
     * @return $this
     */
     ...
     * Sets costPrice
     *
     * @param float $costPrice The cost per unit of stock purchased
     *
     * @return $this
     */
