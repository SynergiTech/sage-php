...
class SalesQuote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SalesQuote';
    ...
    protected static array $openAPITypes = [
        ...
        'sent' => 'bool',
        'sentByEmail' => 'bool',
        'quoteLines' => '\SynergiTech\Sage\Model\SalesQuoteLineItem[]',
    ...
    */
    ...
    public function setQuoteNumberPrefix(?string $quoteNumberPrefix): static
    {
        ...
        if ((mb_strlen($quoteNumberPrefix) > 6)) {
            throw new InvalidArgumentException('invalid length for $quoteNumberPrefix when calling SalesQuote., must be smaller than or equal to 6.');
        }
    ...
    public function setContactName(?string $contactName): static
    {
        ...
        if ((mb_strlen($contactName) > 255)) {
            throw new InvalidArgumentException('invalid length for $contactName when calling SalesQuote., must be smaller than or equal to 255.');
        }
    ...
    public function setContactReference(?string $contactReference): static
    {
        ...
        if ((mb_strlen($contactReference) > 255)) {
            throw new InvalidArgumentException('invalid length for $contactReference when calling SalesQuote., must be smaller than or equal to 255.');
        }
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date of the quote
     *
     * @return $this
     */
     ...
     * Sets expiryDate
     *
     * @param \DateTime|null $expiryDate The expiry date of the quote
     *
     * @return $this
     */
     ...
     *
     * @param string|null $mainAddressFreeForm The free-form main address of the quote Note: An upper length limit of 500 characters is imposed conditionally and may not apply in every request. A hard upper limit of 65535 characters is imposed by the storage layer, though.
     *
     * @return $this
     */
    public function setMainAddressFreeForm(?string $mainAddressFreeForm): static
    {
        ...
        if ((mb_strlen($mainAddressFreeForm) > 500)) {
            throw new InvalidArgumentException('invalid length for $mainAddressFreeForm when calling SalesQuote., must be smaller than or equal to 500.');
        }
     ...
     *
     * @param string|null $deliveryAddressFreeForm The free-form delivery address of the quote Note: An upper length limit of 500 characters is imposed conditionally and may not apply in every request. A hard upper limit of 65535 characters is imposed by the storage layer, though.
     *
     * @return $this
     */
    public function setDeliveryAddressFreeForm(?string $deliveryAddressFreeForm): static
    {
        ...
        if ((mb_strlen($deliveryAddressFreeForm) > 500)) {
            throw new InvalidArgumentException('invalid length for $deliveryAddressFreeForm when calling SalesQuote., must be smaller than or equal to 500.');
        }
    ...
    public function setTermsAndConditions(?string $termsAndConditions): static
    {
        ...
        if ((mb_strlen($termsAndConditions) > 2000)) {
            throw new InvalidArgumentException('invalid length for $termsAndConditions when calling SalesQuote., must be smaller than or equal to 2000.');
        }
     ...
     *
     * @param \SynergiTech\Sage\Model\TaxBreakdown[]|null $shippingTaxBreakdown The shipping tax breakdown for the quote
     *
     * @return $this
     */
     ...
     *
     * @param \SynergiTech\Sage\Model\TaxBreakdown[]|null $baseCurrencyShippingTaxBreakdown The shipping tax breakdown for the  quote in base currency
     *
     * @return $this
     */
     ...
     * Sets totalPaid
     *
     * @param float|null $totalPaid The total paid amount of the quote including any payments, allocations and discounts
     *
     * @return $this
     */
     ...
     * Sets sentByEmail
     *
     * @param bool|null $sentByEmail Indicates whether the quote has been emailed
     *
     * @return $this
     */
     ...
     * Sets quoteLines
     *
     * @param \SynergiTech\Sage\Model\SalesQuoteLineItem[]|null $quoteLines The quote lines of the quote
     *
     * @return $this
     */
     ...
     * Sets taxAnalysis
     *
     * @param \SynergiTech\Sage\Model\ArtefactTaxAnalysis[]|null $taxAnalysis The quote tax analysis
     *
     * @return $this
     */
