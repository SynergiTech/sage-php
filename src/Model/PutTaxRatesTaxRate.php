 ...
 */
class PutTaxRatesTaxRate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'putTaxRates_tax_rate';
    ...
    */
     ...
     * Sets fromDate
     *
     * @param \DateTime|null $fromDate The date from which the tax rate applies
     *
     * @return $this
     */
