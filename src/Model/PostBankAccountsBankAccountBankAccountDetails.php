 ...
 */
class PostBankAccountsBankAccountBankAccountDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postBankAccounts_bank_account_bank_account_details';
