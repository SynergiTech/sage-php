 ...
 */
class CoaTemplate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CoaTemplate';
    ...
    */
    ...
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) > 25)) {
            throw new InvalidArgumentException('invalid length for $id when calling CoaTemplate., must be smaller than or equal to 25.');
        }
     ...
     * Sets name
     *
     * @param string|null $name The name for the COA template
     *
     * @return $this
     */
    public function setName(?string $name): static
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new InvalidArgumentException('invalid length for $name when calling CoaTemplate., must be smaller than or equal to 50.');
        }
