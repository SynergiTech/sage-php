...
/**
 * PutBankReconciliationsBankReconciliation Class Doc Comment
 *
 * @package  SynergiTech\Sage
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PutBankReconciliationsBankReconciliation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'putBankReconciliations_bank_reconciliation';
    ...
    */
     ...
     * Sets bankAccountId
     *
     * @param string|null $bankAccountId The bank account the reconciliation relates to
     *
     * @return $this
     */
