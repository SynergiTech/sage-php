...
/**
 * TaxRatePercentage Class Doc Comment
 *
 * @package  SynergiTech\Sage
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TaxRatePercentage implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TaxRatePercentage';
    ...
    */
     ...
     * Sets percentage
     *
     * @param float|null $percentage The percentage of the rate
     *
     * @return $this
     */
     ...
     * Sets fromDate
     *
     * @param \DateTime|null $fromDate The start date for the rate
     *
     * @return $this
     */
     ...
     * Sets toDate
     *
     * @param \DateTime|null $toDate The end date for the rate
     *
     * @return $this
     */
