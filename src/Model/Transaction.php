...
class Transaction implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'reference' => 'string',
        'total' => 'float',
        'totalInTransactionCurrency' => 'float',
        'contact' => '\SynergiTech\Sage\Model\Base',
        'transactionType' => '\SynergiTech\Sage\Model\Base',
        'origin' => '\SynergiTech\Sage\Model\TransactionOrigin',
        'auditTrailId' => 'string',
    ...
    protected static array $openAPIFormats = [
        ...
        'reference' => null,
        'total' => 'double',
        'totalInTransactionCurrency' => 'double',
        'contact' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'reference' => false,
        'total' => false,
        'totalInTransactionCurrency' => false,
        'contact' => false,
        'transactionType' => false,
        'origin' => false,
        'auditTrailId' => false,
        'numberOfAttachments' => false
    ];
    ...
    protected static array $attributeMap = [
        ...
        'reference' => 'reference',
        'total' => 'total',
        'totalInTransactionCurrency' => 'total_in_transaction_currency',
        'contact' => 'contact',
    ...
    protected static array $setters = [
        ...
        'total' => 'setTotal',
        'totalInTransactionCurrency' => 'setTotalInTransactionCurrency',
        'contact' => 'setContact',
        'transactionType' => 'setTransactionType',
        'origin' => 'setOrigin',
        'auditTrailId' => 'setAuditTrailId',
        'numberOfAttachments' => 'setNumberOfAttachments'
    ];
    ...
    protected static array $getters = [
        ...
        'total' => 'getTotal',
        'totalInTransactionCurrency' => 'getTotalInTransactionCurrency',
        'contact' => 'getContact',
        'transactionType' => 'getTransactionType',
        'origin' => 'getOrigin',
        'auditTrailId' => 'getAuditTrailId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('totalInTransactionCurrency', $data ?? [], null);
        $this->setIfExists('contact', $data ?? [], null);
        $this->setIfExists('transactionType', $data ?? [], null);
        $this->setIfExists('origin', $data ?? [], null);
        $this->setIfExists('auditTrailId', $data ?? [], null);
        $this->setIfExists('numberOfAttachments', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date of the transaction
     *
     * @return $this
     */
     ...
     * Sets deleted
     *
     * @param bool|null $deleted Indicates whether the transaction has been deleted
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param float|null $total The transaction total in the base currency
     *
     * @return $this
     */
    ...
    /**
     * Gets totalInTransactionCurrency
     *
     * @return float|null
     */
    public function getTotalInTransactionCurrency(): ?float
    {
        return $this->container['totalInTransactionCurrency'];
    }

    /**
     * Sets totalInTransactionCurrency
     *
     * @param float|null $totalInTransactionCurrency The transaction total in the transaction's origin's currency. This is null for some origin types.
     *
     * @return $this
     */
    public function setTotalInTransactionCurrency(?float $totalInTransactionCurrency): static
    {
        if (is_null($totalInTransactionCurrency)) {
            throw new InvalidArgumentException('non-nullable totalInTransactionCurrency cannot be null');
        }
        $this->container['totalInTransactionCurrency'] = $totalInTransactionCurrency;
     ...
     * Gets origin
     *
     * @return \SynergiTech\Sage\Model\TransactionOrigin|null
     */
    public function getOrigin(): ?\SynergiTech\Sage\Model\TransactionOrigin
    {
     ...
     * Sets origin
     *
     * @param \SynergiTech\Sage\Model\TransactionOrigin|null $origin origin
     *
     * @return $this
     */
    public function setOrigin(?\SynergiTech\Sage\Model\TransactionOrigin $origin): static
    {
        if (is_null($origin)) {
     ...
     * @return string|null
     */
    public function getAuditTrailId(): ?string
    {
        return $this->container['auditTrailId'];
    }

    /**
     * Sets auditTrailId
     *
     * @param string|null $auditTrailId The original entity that generated the transaction
     *
     * @return $this
     */
    public function setAuditTrailId(?string $auditTrailId): static
    {
        if (is_null($auditTrailId)) {
            throw new InvalidArgumentException('non-nullable auditTrailId cannot be null');
        }
        $this->container['auditTrailId'] = $auditTrailId;

        return $this;
    }

    /**
     * Gets numberOfAttachments
     *
     * @return string|null
     */
    public function getNumberOfAttachments(): ?string
    {
        return $this->container['numberOfAttachments'];
    }

    /**
     * Sets numberOfAttachments
     *
     * @param string|null $numberOfAttachments The number of attachments related to the transaction
     *
     * @return $this
     */
    public function setNumberOfAttachments(?string $numberOfAttachments): static
    {
        if (is_null($numberOfAttachments)) {
            throw new InvalidArgumentException('non-nullable numberOfAttachments cannot be null');
        }
        $this->container['numberOfAttachments'] = $numberOfAttachments;
