...
class Service implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'salesRates' => '\SynergiTech\Sage\Model\Rate[]',
        'sourceGuid' => 'string',
    ...
    */
     ...
     * Sets deletable
     *
     * @param bool|null $deletable Indicates whether the service can be deleted
     *
     * @return $this
     */
     ...
     * Sets deactivatable
     *
     * @param bool|null $deactivatable Indicates whether the service can be deactivated
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $usedOnRecurringInvoice Indicates whether the service has been used on a recurring invoice
     *
     * @return $this
     */
    ...
    public function setItemCode(?string $itemCode): static
    {
        ...
        if ((mb_strlen($itemCode) > 255)) {
            throw new InvalidArgumentException('invalid length for $itemCode when calling Service., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription(?string $description): static
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new InvalidArgumentException('invalid length for $description when calling Service., must be smaller than or equal to 255.');
        }
    ...
    public function setNotes(?string $notes): static
    {
        ...
        if ((mb_strlen($notes) > 500)) {
            throw new InvalidArgumentException('invalid length for $notes when calling Service., must be smaller than or equal to 500.');
        }
     ...
     * Gets salesRates
     *
     * @return \SynergiTech\Sage\Model\Rate[]|null
     */
     ...
     * Sets salesRates
     *
     * @param \SynergiTech\Sage\Model\Rate[]|null $salesRates The sales rates for the service
     *
     * @return $this
     */
    ...
    public function setSourceGuid(?string $sourceGuid): static
    {
        ...
        if ((mb_strlen($sourceGuid) > 255)) {
            throw new InvalidArgumentException('invalid length for $sourceGuid when calling Service., must be smaller than or equal to 255.');
        }
    ...
    public function setPurchaseDescription(?string $purchaseDescription): static
    {
        ...
        if ((mb_strlen($purchaseDescription) > 250)) {
            throw new InvalidArgumentException('invalid length for $purchaseDescription when calling Service., must be smaller than or equal to 250.');
        }
