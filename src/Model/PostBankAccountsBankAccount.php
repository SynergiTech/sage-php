...
class PostBankAccountsBankAccount implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postBankAccounts_bank_account';
    ...
    protected static array $openAPITypes = [
        ...
        'isActive' => 'bool',
        'currencyId' => 'string',
        'bankAccountDetails' => '\SynergiTech\Sage\Model\PostBankAccountsBankAccountBankAccountDetails',
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['bankAccountTypeId'] === null) {
            $invalidProperties[] = "'bankAccountTypeId' can't be null";
        }
     ...
     *
     * @param string $bankAccountTypeId The bank account type for the bank account
     *
     * @return $this
     */
    ...
    public function setNominalCode(?int $nominalCode): static
    {
        ...
        if (($nominalCode > 99999999)) {
            throw new InvalidArgumentException('invalid value for $nominalCode when calling PostBankAccountsBankAccount., must be smaller than or equal to 99999999.');
        }
        if (($nominalCode < 1)) {
            throw new InvalidArgumentException('invalid value for $nominalCode when calling PostBankAccountsBankAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setGifiCode(?int $gifiCode): static
    {
        ...
        if (($gifiCode > 9999)) {
            throw new InvalidArgumentException('invalid value for $gifiCode when calling PostBankAccountsBankAccount., must be smaller than or equal to 9999.');
        }
        if (($gifiCode < 1000)) {
            throw new InvalidArgumentException('invalid value for $gifiCode when calling PostBankAccountsBankAccount., must be bigger than or equal to 1000.');
        }
     ...
     *
     * @return \SynergiTech\Sage\Model\PostBankAccountsBankAccountBankAccountDetails|null
     */
    public function getBankAccountDetails(): ?\SynergiTech\Sage\Model\PostBankAccountsBankAccountBankAccountDetails
    {
     ...
     *
     * @param \SynergiTech\Sage\Model\PostBankAccountsBankAccountBankAccountDetails|null $bankAccountDetails bankAccountDetails
     *
     * @return $this
     */
    public function setBankAccountDetails(?\SynergiTech\Sage\Model\PostBankAccountsBankAccountBankAccountDetails $bankAccountDetails): static
    {
