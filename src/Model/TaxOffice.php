 ...
 */
class TaxOffice implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TaxOffice';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['id']) && (mb_strlen($this->container['id']) > 17)) {
            $invalidProperties[] = "invalid value for 'id', the character length must be smaller than or equal to 17.";
        }

        if (!is_null($this->container['officeNumber']) && (mb_strlen($this->container['officeNumber']) > 4)) {
            $invalidProperties[] = "invalid value for 'officeNumber', the character length must be smaller than or equal to 4.";
        }
    ...
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) > 17)) {
            throw new InvalidArgumentException('invalid length for $id when calling TaxOffice., must be smaller than or equal to 17.');
        }
     ...
     * Sets officeNumber
     *
     * @param string|null $officeNumber The tax office number
     *
     * @return $this
     */
    public function setOfficeNumber(?string $officeNumber): static
    {
        if (is_null($officeNumber)) {
            throw new InvalidArgumentException('non-nullable officeNumber cannot be null');
        }
        if ((mb_strlen($officeNumber) > 4)) {
            throw new InvalidArgumentException('invalid length for $officeNumber when calling TaxOffice., must be smaller than or equal to 4.');
        }
     ...
     * Sets name
     *
     * @param string|null $name The tax office name
     *
     * @return $this
     */
    public function setName(?string $name): static
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new InvalidArgumentException('invalid length for $name when calling TaxOffice., must be smaller than or equal to 255.');
        }
