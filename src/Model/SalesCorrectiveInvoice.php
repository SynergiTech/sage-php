 ...
 */
class SalesCorrectiveInvoice implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SalesCorrectiveInvoice';
    ...
    protected static array $openAPITypes = [
        ...
        'correctiveReasonCode' => '\SynergiTech\Sage\Model\Base',
    ...
    protected static array $attributeMap = [
        ...
        'correctiveReasonCode' => 'corrective_reason_code',
    ...
    protected static array $setters = [
        ...
        'correctiveReasonCode' => 'setCorrectiveReasonCode',
    ...
    protected static array $getters = [
        ...
        'correctiveReasonCode' => 'getCorrectiveReasonCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('correctiveReasonCode', $data ?? [], null);
    ...
    */
    ...
    public function setInvoiceNumberPrefix(?string $invoiceNumberPrefix): static
    {
        ...
        if ((mb_strlen($invoiceNumberPrefix) > 6)) {
            throw new InvalidArgumentException('invalid length for $invoiceNumberPrefix when calling SalesCorrectiveInvoice., must be smaller than or equal to 6.');
        }
    ...
    public function setContactName(?string $contactName): static
    {
        ...
        if ((mb_strlen($contactName) > 255)) {
            throw new InvalidArgumentException('invalid length for $contactName when calling SalesCorrectiveInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setContactReference(?string $contactReference): static
    {
        ...
        if ((mb_strlen($contactReference) > 255)) {
            throw new InvalidArgumentException('invalid length for $contactReference when calling SalesCorrectiveInvoice., must be smaller than or equal to 255.');
        }
    ...
    public function setMainAddressFreeForm(?string $mainAddressFreeForm): static
    {
        ...
        if ((mb_strlen($mainAddressFreeForm) > 500)) {
            throw new InvalidArgumentException('invalid length for $mainAddressFreeForm when calling SalesCorrectiveInvoice., must be smaller than or equal to 500.');
        }
    ...
    public function setDeliveryAddressFreeForm(?string $deliveryAddressFreeForm): static
    {
        ...
        if ((mb_strlen($deliveryAddressFreeForm) > 500)) {
            throw new InvalidArgumentException('invalid length for $deliveryAddressFreeForm when calling SalesCorrectiveInvoice., must be smaller than or equal to 500.');
        }
    ...
    public function setTermsAndConditions(?string $termsAndConditions): static
    {
        ...
        if ((mb_strlen($termsAndConditions) > 2000)) {
            throw new InvalidArgumentException('invalid length for $termsAndConditions when calling SalesCorrectiveInvoice., must be smaller than or equal to 2000.');
        }
    ...
    public function setVoidReason(?string $voidReason): static
    {
        ...
        if ((mb_strlen($voidReason) > 200)) {
            throw new InvalidArgumentException('invalid length for $voidReason when calling SalesCorrectiveInvoice., must be smaller than or equal to 200.');
        }
     ...
     *
     * @param float|null $withholdingTaxRate IRPF Witheld Tax Rate (Spain only)
     *
     * @return $this
     */
     ...
     *
     * @param float|null $withholdingTaxAmount IRPF Witheld Tax Amount (Spain only)
     *
     * @return $this
     */
     ...
     *
     * @param float|null $baseCurrencyWithholdingTaxAmount IRPF Witheld Tax Amount (Spain only) in the base currency
     *
     * @return $this
     */
    ...
    /**
     * Gets correctiveReasonCode
     *
     * @return \SynergiTech\Sage\Model\Base|null
     */
    public function getCorrectiveReasonCode(): ?\SynergiTech\Sage\Model\Base
    {
        return $this->container['correctiveReasonCode'];
    }

    /**
     * Sets correctiveReasonCode
     *
     * @param \SynergiTech\Sage\Model\Base|null $correctiveReasonCode correctiveReasonCode
     *
     * @return $this
     */
    public function setCorrectiveReasonCode(?\SynergiTech\Sage\Model\Base $correctiveReasonCode): static
    {
        if (is_null($correctiveReasonCode)) {
            throw new InvalidArgumentException('non-nullable correctiveReasonCode cannot be null');
        }
        $this->container['correctiveReasonCode'] = $correctiveReasonCode;
     ...
     *
     * @param string|null $originalInvoiceNumber The number relating to the original invoice
     *
     * @return $this
     */
     ...
     *
     * @param string|null $originalInvoiceDate The Invoice date relating to the original invoice
     *
     * @return $this
     */
     ...
     * Sets details
     *
     * @param string|null $details The corrective invoice details
     *
     * @return $this
     */
