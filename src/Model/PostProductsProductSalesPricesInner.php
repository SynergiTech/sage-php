...
/**
 * PostProductsProductSalesPricesInner Class Doc Comment
 *
 * @package  SynergiTech\Sage
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostProductsProductSalesPricesInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postProducts_product_sales_prices_inner';
    ...
    {
        $this->setIfExists('priceName', $data ?? [], null);
        $this->setIfExists('price', $data ?? [], null);
        $this->setIfExists('priceIncludesTax', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['priceName'];
    }

    /**
     * Sets priceName
     *
     * @param string|null $priceName The name of the product sales price
     *
     * @return $this
     */
    public function setPriceName(?string $priceName): static
    {
        if (is_null($priceName)) {
            throw new InvalidArgumentException('non-nullable priceName cannot be null');
        }
        $this->container['priceName'] = $priceName;
     ...
     * Sets price
     *
     * @param float|null $price The sales price amount
     *
     * @return $this
     */
    ...
    /**
     * Gets priceIncludesTax
     *
     * @return bool|null
     */
    public function getPriceIncludesTax(): ?bool
    {
        return $this->container['priceIncludesTax'];
    }

    /**
     * Sets priceIncludesTax
     *
     * @param bool|null $priceIncludesTax Indicates whether the sales price already includes tax
     *
     * @return $this
     */
    public function setPriceIncludesTax(?bool $priceIncludesTax): static
    {
        if (is_null($priceIncludesTax)) {
            throw new InvalidArgumentException('non-nullable priceIncludesTax cannot be null');
        }
        $this->container['priceIncludesTax'] = $priceIncludesTax;
