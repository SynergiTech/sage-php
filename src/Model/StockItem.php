...
class StockItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'StockItem';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['itemCode']) && (mb_strlen($this->container['itemCode']) > 30)) {
            $invalidProperties[] = "invalid value for 'itemCode', the character length must be smaller than or equal to 30.";
        }
     ...
     * Sets deletable
     *
     * @param bool|null $deletable Indicates whether the stock item can be deleted
     *
     * @return $this
     */
     ...
     * Sets deactivatable
     *
     * @param bool|null $deactivatable Indicates whether the stock item can be deactivated
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $usedOnRecurringInvoice Indicates whether the stock item has been used on a recurring invoice
     *
     * @return $this
     */
    ...
    public function setItemCode(?string $itemCode): static
    {
        ...
        if ((mb_strlen($itemCode) > 30)) {
            throw new InvalidArgumentException('invalid length for $itemCode when calling StockItem., must be smaller than or equal to 30.');
        }
     ...
     * Sets salesPrices
     *
     * @param \SynergiTech\Sage\Model\SalesPrice[]|null $salesPrices The sales prices for the stock item
     *
     * @return $this
     */
    ...
    public function setSourceGuid(?string $sourceGuid): static
    {
        ...
        if ((mb_strlen($sourceGuid) > 255)) {
            throw new InvalidArgumentException('invalid length for $sourceGuid when calling StockItem., must be smaller than or equal to 255.');
        }
    ...
    public function setPurchaseDescription(?string $purchaseDescription): static
    {
        ...
        if ((mb_strlen($purchaseDescription) > 250)) {
            throw new InvalidArgumentException('invalid length for $purchaseDescription when calling StockItem., must be smaller than or equal to 250.');
        }
