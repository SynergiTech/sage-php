 ...
 */
class ProductSalesPriceType implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductSalesPriceType';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the product sales price type
     *
     * @return $this
     */
     ...
     * Sets active
     *
     * @param bool|null $active Indicates whether the price type is displayed in the application
     *
     * @return $this
     */
