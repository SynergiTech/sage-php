 ...
 */
class PostSalesEstimatesSalesEstimate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postSalesEstimates_sales_estimate';
    ...
    protected static array $openAPITypes = [
        ...
        'estimateLines' => '\SynergiTech\Sage\Model\PostSalesEstimatesSalesEstimateEstimateLinesInner[]',
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['estimateLines'] === null) {
            $invalidProperties[] = "'estimateLines' can't be null";
        }
     ...
     * Sets contactId
     *
     * @param string $contactId The contact the estimate relates to
     *
     * @return $this
     */
     ...
     * Sets expiryDate
     *
     * @param \DateTime $expiryDate The expiry date of the estimate
     *
     * @return $this
     */
     ...
     * Sets estimateLines
     *
     * @param \SynergiTech\Sage\Model\PostSalesEstimatesSalesEstimateEstimateLinesInner[] $estimateLines The estimate lines of the estimate
     *
     * @return $this
     */
