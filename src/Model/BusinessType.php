 ...
 */
class BusinessType implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BusinessType';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the business type
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description The description of the business type
     *
     * @return $this
     */
