 ...
 */
class PurchaseQuickEntry implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PurchaseQuickEntry';
    ...
    */
    ...
    public function setContactName(?string $contactName): static
    {
        ...
        if ((mb_strlen($contactName) > 255)) {
            throw new InvalidArgumentException('invalid length for $contactName when calling PurchaseQuickEntry., must be smaller than or equal to 255.');
        }
    ...
    public function setContactReference(?string $contactReference): static
    {
        ...
        if ((mb_strlen($contactReference) > 255)) {
            throw new InvalidArgumentException('invalid length for $contactReference when calling PurchaseQuickEntry., must be smaller than or equal to 255.');
        }
