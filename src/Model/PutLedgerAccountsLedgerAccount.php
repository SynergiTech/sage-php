 ...
 */
class PutLedgerAccountsLedgerAccount implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'putLedgerAccounts_ledger_account';
    ...
    */
     ...
     *
     * @param string|null $ledgerAccountTypeId The ledger account type for the ledger account
     *
     * @return $this
     */
    ...
    public function setNominalCode(?int $nominalCode): static
    {
        ...
        if (($nominalCode > 99999999)) {
            throw new InvalidArgumentException('invalid value for $nominalCode when calling PutLedgerAccountsLedgerAccount., must be smaller than or equal to 99999999.');
        }
        if (($nominalCode < 1)) {
            throw new InvalidArgumentException('invalid value for $nominalCode when calling PutLedgerAccountsLedgerAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setGifiCode(?int $gifiCode): static
    {
        ...
        if (($gifiCode > 9999)) {
            throw new InvalidArgumentException('invalid value for $gifiCode when calling PutLedgerAccountsLedgerAccount., must be smaller than or equal to 9999.');
        }
        if (($gifiCode < 1000)) {
            throw new InvalidArgumentException('invalid value for $gifiCode when calling PutLedgerAccountsLedgerAccount., must be bigger than or equal to 1000.');
        }
