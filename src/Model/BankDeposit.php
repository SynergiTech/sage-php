 ...
 */
class BankDeposit implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BankDeposit';
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime|null $date User generated date of transaction, not necessarily when it was created
     *
     * @return $this
     */
     ...
     * Sets cashAmount
     *
     * @param float|null $cashAmount Cash total in the deposit
     *
     * @return $this
     */
