...
/**
 * BankReconciliationStatus Class Doc Comment
 *
 * @package  SynergiTech\Sage
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BankReconciliationStatus implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BankReconciliationStatus';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The bank reconciliation status id
     *
     * @return $this
     */
     ...
     * Sets displayedAs
     *
     * @param string|null $displayedAs The bank reconciliation status name
     *
     * @return $this
     */
