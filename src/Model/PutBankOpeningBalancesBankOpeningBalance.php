 ...
 */
class PutBankOpeningBalancesBankOpeningBalance implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'putBankOpeningBalances_bank_opening_balance';
    ...
    */
     ...
     * Sets bankAccountId
     *
     * @param string|null $bankAccountId The bank account the opening balance relates to
     *
     * @return $this
     */
