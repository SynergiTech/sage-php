 ...
 */
class MigrationStatus implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MigrationStatus';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The migration status id
     *
     * @return $this
     */
     ...
     * Sets displayedAs
     *
     * @param string|null $displayedAs The migration status name
     *
     * @return $this
     */
