 ...
 */
class PostAddressesAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postAddresses_address';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['addressTypeId'] === null) {
            $invalidProperties[] = "'addressTypeId' can't be null";
        }
        if ($this->container['name'] === null) {
            $invalidProperties[] = "'name' can't be null";
        }
        if ($this->container['isMainAddress'] === null) {
            $invalidProperties[] = "'isMainAddress' can't be null";
        }
     ...
     * Sets addressTypeId
     *
     * @param string $addressTypeId Defines the nature of the address (Shipping, Billing, Head Office etc.).<br>Start defaults to \"Sales\" for Customers and \"Purchasing\" for Vendors
     *
     * @return $this
     */
     ...
     * Sets isMainAddress
     *
     * @param bool $isMainAddress Specifies the address as the contact's main address. Only a single address can exist for a contact in Start so this is always true when returned by the API but cannot be seen in the UI
     *
     * @return $this
     */
