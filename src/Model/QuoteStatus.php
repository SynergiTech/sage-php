 ...
 */
class QuoteStatus implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'QuoteStatus';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The quote status id
     *
     * @return $this
     */
     ...
     * Sets displayedAs
     *
     * @param string|null $displayedAs The quote status name
     *
     * @return $this
     */
