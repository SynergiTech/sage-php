...
class PostContactsContact implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postContacts_contact';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['contactTypeIds'] === null) {
            $invalidProperties[] = "'contactTypeIds' can't be null";
        }
     ...
     * Sets contactTypeIds
     *
     * @param string[] $contactTypeIds The IDs of the Contact Types.
     *
     * @return $this
     */
    ...
    public function setCreditDays(?int $creditDays): static
    {
        ...
        if (($creditDays > 365)) {
            throw new InvalidArgumentException('invalid value for $creditDays when calling PostContactsContact., must be smaller than or equal to 365.');
        }
        if (($creditDays < 0)) {
            throw new InvalidArgumentException('invalid value for $creditDays when calling PostContactsContact., must be bigger than or equal to 0.');
        }
