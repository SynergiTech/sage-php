...
/**
 * PostContactPersonsContactPerson Class Doc Comment
 *
 * @package  SynergiTech\Sage
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PostContactPersonsContactPerson implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'postContactPersons_contact_person';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['contactPersonTypeIds'] === null) {
            $invalidProperties[] = "'contactPersonTypeIds' can't be null";
        }
     ...
     * Sets addressId
     *
     * @param string $addressId The address of the contact person
     *
     * @return $this
     */
     ...
     *
     * @param string[] $contactPersonTypeIds The IDs of the Contact Person Types.
     *
     * @return $this
     */
