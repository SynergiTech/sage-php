 ...
 */
class SalesCreditNote implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SalesCreditNote';
    ...
    protected static array $openAPITypes = [
        ...
        'sentByEmail' => 'bool',
        'voidReason' => 'string',
        'creditNoteLines' => '\SynergiTech\Sage\Model\SalesCreditNoteLineItem[]',
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['creditNoteNumberPrefix']) && (mb_strlen($this->container['creditNoteNumberPrefix']) > 6)) {
            $invalidProperties[] = "invalid value for 'creditNoteNumberPrefix', the character length must be smaller than or equal to 6.";
        }
        ...
        if (!is_null($this->container['termsAndConditions']) && (mb_strlen($this->container['termsAndConditions']) > 65535)) {
            $invalidProperties[] = "invalid value for 'termsAndConditions', the character length must be smaller than or equal to 65535.";
        }
     ...
     *
     * @param string|null $taxCalculationMethod The tax calculation method, if applicable, for this sales credit note, returns invoice or cash.
     *
     * @return $this
     */
    ...
    public function setCreditNoteNumberPrefix(?string $creditNoteNumberPrefix): static
    {
        ...
        if ((mb_strlen($creditNoteNumberPrefix) > 6)) {
            throw new InvalidArgumentException('invalid length for $creditNoteNumberPrefix when calling SalesCreditNote., must be smaller than or equal to 6.');
        }
    ...
    public function setContactName(?string $contactName): static
    {
        ...
        if ((mb_strlen($contactName) > 255)) {
            throw new InvalidArgumentException('invalid length for $contactName when calling SalesCreditNote., must be smaller than or equal to 255.');
        }
    ...
    public function setContactReference(?string $contactReference): static
    {
        ...
        if ((mb_strlen($contactReference) > 255)) {
            throw new InvalidArgumentException('invalid length for $contactReference when calling SalesCreditNote., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param string|null $mainAddressFreeForm The free-form main address of the credit note Note: An upper length limit of 500 characters is imposed conditionally and may not apply in every request. A hard upper limit of 65535 characters is imposed by the storage layer, though.
     *
     * @return $this
     */
    public function setMainAddressFreeForm(?string $mainAddressFreeForm): static
    {
        ...
        if ((mb_strlen($mainAddressFreeForm) > 500)) {
            throw new InvalidArgumentException('invalid length for $mainAddressFreeForm when calling SalesCreditNote., must be smaller than or equal to 500.');
        }
     ...
     *
     * @param string|null $deliveryAddressFreeForm The free-form delivery address of the credit note Note: An upper length limit of 500 characters is imposed conditionally and may not apply in every request. A hard upper limit of 65535 characters is imposed by the storage layer, though.
     *
     * @return $this
     */
    public function setDeliveryAddressFreeForm(?string $deliveryAddressFreeForm): static
    {
        ...
        if ((mb_strlen($deliveryAddressFreeForm) > 500)) {
            throw new InvalidArgumentException('invalid length for $deliveryAddressFreeForm when calling SalesCreditNote., must be smaller than or equal to 500.');
        }
    ...
    public function setTermsAndConditions(?string $termsAndConditions): static
    {
        ...
        if ((mb_strlen($termsAndConditions) > 65535)) {
            throw new InvalidArgumentException('invalid length for $termsAndConditions when calling SalesCreditNote., must be smaller than or equal to 65535.');
        }
     ...
     *
     * @param \SynergiTech\Sage\Model\TaxBreakdown[]|null $shippingTaxBreakdown The shipping tax breakdown for the credit note
     *
     * @return $this
     */
     ...
     * Sets totalPaid
     *
     * @param float|null $totalPaid The total paid amount of the credit note including any payments, allocations and discounts
     *
     * @return $this
     */
     ...
     *
     * @param float|null $outstandingAmount The outstanding amount of the credit note
     *
     * @return $this
     */
     ...
     *
     * @param \SynergiTech\Sage\Model\TaxBreakdown[]|null $baseCurrencyShippingTaxBreakdown The shipping tax breakdown for the credit note in base currency
     *
     * @return $this
     */
     ...
     *
     * @param float|null $baseCurrencyOutstandingAmount The outstanding amount of the credit note in base currency
     *
     * @return $this
     */
     ...
     * Sets sentByEmail
     *
     * @param bool|null $sentByEmail Indicates whether the credit note has been emailed
     *
     * @return $this
     */
     ...
     * Sets voidReason
     *
     * @param string|null $voidReason The reason the credit note was voided
     *
     * @return $this
     */
    public function setVoidReason(?string $voidReason): static
    {
        ...
        if ((mb_strlen($voidReason) > 200)) {
            throw new InvalidArgumentException('invalid length for $voidReason when calling SalesCreditNote., must be smaller than or equal to 200.');
        }
     ...
     *
     * @return \SynergiTech\Sage\Model\SalesCreditNoteLineItem[]|null
     */
     ...
     *
     * @param \SynergiTech\Sage\Model\SalesCreditNoteLineItem[]|null $creditNoteLines The credit note lines of the credit note
     *
     * @return $this
     */
     ...
     * Sets taxAnalysis
     *
     * @param \SynergiTech\Sage\Model\ArtefactTaxAnalysis[]|null $taxAnalysis The credit note tax analysis
     *
     * @return $this
     */
     ...
     * Sets taxReconciled
     *
     * @param bool|null $taxReconciled Indicates if the sales credit note is tax reconciled or not.
     *
     * @return $this
     */
     ...
     * Sets migrated
     *
     * @param bool|null $migrated Indicates if the sales credit note was migrated from another system.
     *
     * @return $this
     */
