 ...
 */
class PutAttachmentsAttachment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'putAttachments_attachment';
    ...
    */
    ...
    public function setFileSize(?int $fileSize): static
    {
        ...
        if (($fileSize > 2621440)) {
            throw new InvalidArgumentException('invalid value for $fileSize when calling PutAttachmentsAttachment., must be smaller than or equal to 2621440.');
        }
        if (($fileSize < 0)) {
            throw new InvalidArgumentException('invalid value for $fileSize when calling PutAttachmentsAttachment., must be bigger than or equal to 0.');
        }
