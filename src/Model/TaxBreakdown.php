 ...
 */
class TaxBreakdown implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TaxBreakdown';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount The tax amount for the given tax rate
     *
     * @return $this
     */
