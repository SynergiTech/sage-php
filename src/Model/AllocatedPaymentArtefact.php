 ...
 */
class AllocatedPaymentArtefact implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AllocatedPaymentArtefact';
