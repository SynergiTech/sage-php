...
/**
 * JournalCodeType Class Doc Comment
 *
 ...
 */
class JournalCodeType implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'JournalCodeType';
    ...
    */
    ...
    public function setId(?string $id): static
    {
        ...
        if ((mb_strlen($id) > 20)) {
            throw new InvalidArgumentException('invalid length for $id when calling JournalCodeType., must be smaller than or equal to 20.');
        }
