...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://api-qa.sageapim.com/uki/sageone/accounts/v3';
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/2024.09.03/PHP';
    ...
    {
        $report  = 'PHP SDK (SynergiTech\Sage) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0' . PHP_EOL;
        $report .= '    SDK Package Version: 2024.09.03' . PHP_EOL;
    ...
    public function getHostSettings(): array
    {
        return [
            [
                "url" => "https://api-qa.sageapim.com/uki/sageone/accounts/v3",
